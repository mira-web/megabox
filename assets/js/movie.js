(function($){
    ...
    (function handleTrailer(){
        ...
        var body = $("body"),
            overlay = $("#blackout"),
        초보자는 이렇게 쓸 수도 있지만 위의 방법으로도 할 수도 있다.
        */
        ...
        // 보이기, 숨기기 버튼 활성화
        $selector.showButton.on( "click", showPlayer ); // 시작버튼을 누르면 showPlayer라는 함수가 활성화된다. 
        $selector.hideButton.on( "click", hidePlayer ); // 닫기버튼을 누르면 hidePlayer라는 함수가 활성화된다. 
